...
public class TestRegressionN {
	public static void main(String[] args) {
		
		
		double[][] points = {{0,0},{1,56.5},{5,113},{20,181}};
		// double[][] points = {{0,0},{1,2},{30,0}};
		
		//double[][] points = {{-15,0},{15,0},{-14,2}};
...
//		
		...
		for( int i = 0; i< solve.length; i++ )
			System.out.println( "a_"+i+"= " + solve[ i ] );
